...
(0..19).each do |y|
  ...
  if x >= 3
    ...
    if y >= 3
      left_up = data[y][x] * data[y-1][x-1] * data[y-2][x-2] * data[y-3][y-3]
      left_up > max ? max = left_up : false
    end
  end
